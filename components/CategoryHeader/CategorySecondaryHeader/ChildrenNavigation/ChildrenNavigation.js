...
export default function ChildrenNavigation({
  ...
  return (
    <>
      {/* Overlay blur di luar menu Guides */}
      {isNavShown && (
        <div
      ...
      >
        ...
        >
          {/* Tombol kiri: label = nama parent category, aksi = toggle Guides */}
          <div
            className={cx(
          ...
          {/* Daftar subkategori (saudara di bawah parent) */}
          <div
            className={cx(
              'navigation-wrapper',
              isMainNavShown || isNavShown ? 'show' : undefined,
