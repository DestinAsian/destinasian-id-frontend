...
export default function CategoryHeaderTravelGuide({
  ...
  const travelGuidesPerPage = 1000
  ...
  // Initialize an array to store unique travelGuides
  const contentNodesTravelGuides = []
  ...
  searchResultsData?.categories?.edges?.forEach((travelGuide) => {
    ...
    if (!uniqueDatabaseIds.has(databaseId)) {
      ...
      contentNodesTravelGuides.push(travelGuide.node)
    }
  })
  ...
  // Sort contentNodesTravelGuides array by date
  contentNodesTravelGuides.sort((a, b) => {
    // Assuming your date is stored in 'date' property of the travelGuide objects
...
210 215 210 3 0 195 -190 427 -422z"
      ...
      <div className={cx('search-bar-wrapper')}>
        ...
        <div className={cx('search-result-wrapper')}>
          ...
          {isSearchResultsVisible && (
            <SearchResults
              searchResults={contentNodesTravelGuides}
      ...
      >
        <FullMenu
          ...
          contentNodesTravelGuides={contentNodesTravelGuides}
