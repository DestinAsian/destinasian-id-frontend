...
import styles from "./PreviewInterscroller.module.scss";
...
export default function PreviewInterscroller() {
    ...
    >
      <div className={cx("interscroller-wrapper")}>
        ...
        <div className={cx("interscroller-banner")}>
          ...
          <Ad
            adUnit="/6808792/DAMAN_PREVIEW_INTERSCROLLER"
            name="div-gpt-ad-1741856294417-0"
            size={[300, 600]}
          />
        </div>
